...
import static com.smartdev.mynotesapp.db.DatabaseContract.NoteColumns.DATE;
import static com.smartdev.mynotesapp.db.DatabaseContract.NoteColumns.DESCRIPTION;
import static com.smartdev.mynotesapp.db.DatabaseContract.NoteColumns.TITLE;
...
public class NoteAddUpdateActivity extends AppCompatActivity implements  View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * */
        ...
        /*
        * terapkan aksi ketika tombol diklik. Di sini ketika data berhasil ditambahka ke database,
        * kita akan mengembalikan nilai dengan menggunakan setResult, hal ini sama dengan saat kita belajar di materi Intent dengan ResultActivity.
        * */
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_submit) {
           ...
           /*
            ...
            /*
            Jika merupakan edit maka setresultnya UPDATE,
             dan jika bukan maka setresultnya ADD
            */
            if (isEdit) {
    ...
    /*
    * Ketika pengguna berada pada proses pembaruan data, setiap kolom pada form sudah terisi otomatis.
    * Ikon untuk hapus di sudut kanan atas ActionBar berfungsi untuk menghapus data. Kode berikut akan menjalankan kebutuhan di atas. Intinya cek nilai boolean isEdit yang berasal dari proses validasi, apakah objek note berisi null atau tidak.
    * */
    //override metode onCreateOptionsMenu untuk memanggil menu.xml.
   @Override
    ...
    //saat menekan tombol back (kembali), kita ingin memunculkan AlertDialog. Panggil metode onBackPressed.
   /*
   ...
   * */
    ...
    /*
    * Pada proses penghapusan data, dialog konfirmasi tampil. Ia pun muncul ketika pengguna menekan tombol back baik pada ActionBar atau peranti.
    ...
    * */
    //buat metode showAlertDialog untuk memunculkan dialognya dan mengembalikan nilai result untuk diterima halaman MainActivity nantinya.
    /*
