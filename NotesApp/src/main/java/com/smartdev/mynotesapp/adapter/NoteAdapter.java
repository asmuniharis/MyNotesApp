package com.smartdev.mynotesapp.adapter;
...
import com.smartdev.mynotesapp.CustomOnItemClickListener;
import com.smartdev.mynotesapp.NoteAddUpdateActivity;
import com.smartdev.mynotesapp.R;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteViewHolder> {
    ...
    public NoteAdapter(Activity activity) {//konstruktor
        this.activity = activity;
    }

    public ArrayList<Note> getListNotes() {//getter array list
        return listNotes;
    }
